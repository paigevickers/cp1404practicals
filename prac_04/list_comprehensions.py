...
# list of lower-case full names
lowercase_full_names = [name.lower() for name in full_names]

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# list of integers from the above list of strings
numbers = [int(number) for number in almost_numbers]
print(numbers)

#  list of only the numbers that are greater than 9
numbers = [number for number in numbers if number > 9]
print(numbers)


# string (not list) of the last names for those full names longer than 11 characters
